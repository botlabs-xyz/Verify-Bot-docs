...
VerifyBot helps server staff run reliable verification workflows with clear logs, role controls, and trust checks.
...
- Manual user verification (`/verify`)
- Reaction-based verification setup (`/setreactionverify`)
- Verification role allowlist management
